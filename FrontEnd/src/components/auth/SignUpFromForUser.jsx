        ...
        <div className="w-full mx-auto">
          <div className="flex justify-center items-center">
            <form className="w-1/2">
              ...
              <a
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-black bg-white hover:text-white hover:bg-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-white"
                href="#!"
              >
                <i className="mr-2 h-5 w-5 fa-regular fa-envelope"></i>
                Continue with Gmail
              </a>
            </form>
          </div>
