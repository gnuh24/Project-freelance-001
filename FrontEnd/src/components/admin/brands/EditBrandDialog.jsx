...
import { postBrandApiThunk, putBrandApiThunk } from '../../../reducers/productReducer/BrandSlice';
                ...
                <div className='flex items-center justify-center'>
                  {formValues.logo ?
                    <div className='relative h-20 w-20'>
                      <img
                        src={formValues.logo instanceof File ? URL.createObjectURL(formValues.logo) : `http://localhost:8080/Brand/Image/${data.logo}`}
                        alt="BrandImage"
                        className="rounded-md w-[5rem] h-[5rem] object-cover"
                      />
                      <button
                        onClick={() => setFormValues({ ...formValues, logo: null })}
