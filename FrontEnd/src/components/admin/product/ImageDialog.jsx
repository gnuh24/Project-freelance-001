    ...
    <Dialog open={open}>
      <div className="relative w-[30rem] p-2 space-y-4">
        ...
        <button
          ...
          className="bg-blue-600 w-full hover:bg-blue-700 transition py-2 text-white"
        >
          Lưu
        </button>
      </div>
